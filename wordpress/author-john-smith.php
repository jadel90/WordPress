...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
        ...
        <div class="author-bg" style="height: 260px; width: 194px; background-image: url('<?php echo esc_url(get_template_directory_uri() . '/man-image-1.png'); ?>'); background-repeat: no-repeat;"> </div>
